...
struct Constants {
    ...
    static let tabColor = #colorLiteral(red: 0.89619416, green: 0.8908668756, blue: 0.9002892375, alpha: 1)
    static let tableViewBackgroundColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
    static let textAttributes = [NSAttributedStringKey.foregroundColor:UIColor.white]
    static let font = ".SFUIText"
    static let buttonColor = #colorLiteral(red: 0.9194820523, green: 0.2281229496, blue: 0.2535354197, alpha: 1)
